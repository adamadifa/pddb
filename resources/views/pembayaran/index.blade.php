                                    ...
                                    <div class="card-content">
                                        <div class="card-body">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <x-inputtext label="Tanggal Bayar" field="tgl_bayar" icon="feather icon-calendar"
                                                            datepicker="true" />
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <x-inputtext label="Biaya Pendaftaran"
                                                            value="{{ number_format($pendaftar->biaya_pendaftaran, '0', '', '.') }}"
                                                            field="biaya_pendaftaran" icon="fa fa-money" readonly="true" />
                                                    </div>
                                                </div>

                                                <div class="row">
                                                    <div class="col-12">
                                                        <x-inputtext label="Upload Bukti Pembayaran" field="bukti_pembayaran" type="file"
                                                            icon="feather icon-upload" />
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <button type="submit" class="btn btn-primary btn-block mr-1 mb-1 btn-block">Konfirmasi
                                                        Pembayaran</button>
                                                </div>
                                            </div>
                                        </div>
